...
run1 <- TmLDASimulation(cleanCorpus, 5, alpha, beta, iter, iter, keep)
run2 <- TmLDASimulation(cleanCorpus, 5, alpha, beta, iter, iter, keep)

source("KL-distance.R")

res <- KLdistFromRunResults(run1, run2)
